...
description: Execute the implementation plan by processing and executing all tasks
  defined in tasks.md. Infrahub-aware — invokes the matching Infrahub skill before
  tasks that touch schemas, transforms, checks, generators, menus, or seed objects.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: infrahub:.composed/speckit.implement.md
---
