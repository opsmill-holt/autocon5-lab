...
description: Create or update the feature specification from a natural language feature
  description, with Infrahub artifact routing when .infrahub.yml is detected.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: infrahub:.composed/speckit.specify.md
---
...
**Override for the core workflow below** — When the core instructions reference `.specify/templates/spec-template.md` or "spec-template", use the Infrahub template selected above instead. The rest of the core flow (branch creation hook, feature directory, quality checklist, reporting, after_specify hooks) runs unchanged.
